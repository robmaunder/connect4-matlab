function [winner, grid] = run_game(players, rows, columns, how_many_to_connect, difficulty)
...
for turn = 1:rows*columns
    ...
    preferred_columns = my_function(grid, player, how_many_to_connect, difficulty);
